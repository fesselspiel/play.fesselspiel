...
check(contentSpaces.includes("canEditContentEntry(viewer, entry, entry.space)") && contentSpaces.includes("canEditOwner(viewer, entry.page.ownerId)"), "Bearbeitungsrechte fuer Inhaltsbereich-Eintraege duerfen nicht pauschal true sein");
