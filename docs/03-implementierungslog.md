...
- Sprachausgabe-Ereignisse sind nun ebenfalls eigene fachliche Auslöser: `Sprachausgabe wurde gestartet`, `Sprachausgabe wurde beendet` und `Sprachausgabe meldet Fehler`. Bridge-Claims erzeugen den Start, Bridge-Resultate das Ende oder den Fehler; externe Event-Meldungen materialisieren den Voice-Zustand passend.
