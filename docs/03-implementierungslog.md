...
- Automation-Oberflächen haben nun zentrale Fallback-Texte für unbekannte Zustände, Quellen, Rollen, Integrationen und Aktionen. Dadurch rutschen neue oder externe technische Keys nicht mehr ungefiltert in normale Admin-Ansichten; die Rohwerte bleiben weiterhin unter `Technische Details` nachvollziehbar.
