...
Ein Tracker kann `quotaReminderEnabled` und `quotaReminderIntervalMinutes` enthalten. Zulässige Intervalle sind `60`, `180`, `360`, `720` und `1440` Minuten; ohne expliziten Wert gilt einmal täglich. Die Einstellung wird separat je Tracker gespeichert. Der Tracker-Cron prüft im 15-Minuten-Raster und erinnert nur bei einem tatsächlich offenen Kontingent in einem sinnvollen Zeitfenster: Tagesziele ab 18 Uhr, Kalenderwochenziele ab 18 Uhr am letzten Tag der jeweiligen Tracker-Woche und Monatsziele ab 18 Uhr am letzten Monatstag. Bei rollierenden Wochenzielen ist jeder Tag ein mögliches Periodenende, deshalb gilt dort ebenfalls das Zeitfenster ab 18 Uhr. `quotaReminderIntervalMinutes` ist innerhalb dieses Fensters der Mindestabstand für weitere Erinnerungen. Ein vollständiges oder nicht vorhandenes Kontingent erzeugt keine Erinnerung.
