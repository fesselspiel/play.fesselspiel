...
| --- | --- | --- |
| Altersfreigabe | App fertig / ASC offen | Kein hartes Gate im Standard. Der Hinweis fuer Erwachsene und die Bedingungen sind produktiv; optionales Mandantengate ist reversibel vorhanden. Der Altersfragebogen in App Store Connect bleibt manuell. |
