...
- Rueckbau: Serializer-Viewerparameter, Block-/Moderationsfilter, `contentEntry`-Reportresolver und zugehoerige Verifierchecks gemeinsam revertieren. Keine Datenbankmigration und kein Eingriff in Produktivdaten. Zyklus `5/5` nach TestFlight Build 107; der iOS-Upload wird separat nach bestaetigter Verarbeitung dokumentiert.
