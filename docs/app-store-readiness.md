...
| 2.3 | Metadaten | Deutsche Store-Texte, Support-/Privacy-URL, Review Notes, Review-Kontakt, Demo-Zugang und ehrliche Altersdeklaration in ASC gesetzt | iOS `fastlane/metadata`, `docs/app-review-notes.md`, `store_review_details` | Fastlane-Laeufe, ASC-API-Readback und echter Demo-Login | Teilweise erfuellt | Neutrale Store-Screenshots und Privacy Labels bleiben manuell |
...
- App Store Connect enthaelt Store-Texte, Support-/Privacy-URL, ehrliche 18+-Altersdeklaration, Review-Kontakt, Review Notes und einen live geprueften Demo-Zugang. Privacy Labels und neutrale Store-Screenshots bleiben zu setzen.
