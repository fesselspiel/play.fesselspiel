...
- App Store Connect enthaelt Store-Texte, Support-/Privacy-URL, Lifestyle als Primaer- und Productivity als Sekundaerkategorie, ehrliche 18+-Altersdeklaration, Review-Kontakt, Review Notes, einen live geprueften Demo-Zugang, je drei neutrale iPhone- und iPad-Screenshots sowie 15 veroeffentlichte Privacy-Deklarationen. Build `1.0 (111)` ist `VALID`, intern `IN_BETA_TESTING`, export-compliance-bereinigt und einer internen All-Builds-Gruppe mit Tester zugeordnet; die vorbereitete Store-Version verwendet Build 111 und `AFTER_APPROVAL`. Es wurde keine Review-Einreichung erzeugt.
...
| 4 UGC, Melden, Blockieren | Erfuellt nach Live-Deploy | fremde Kerninhalte meldbar/ausblendbar, Blockfilter, Admin-Moderation; neue zentrale Filterung fuer direkte/Zirkel-Shares und bestehende Share-Links | Share-Fix deployen, reversiblen Zwei-Nutzer-Smoke ausfuehren; Moderationspostfach und SLA personell sicherstellen |
