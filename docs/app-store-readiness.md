...
| 2.3 | Metadaten | Deutsche Store-Texte, Support-/Privacy-/Privacy-Choices-URL, Copyright, Lifestyle-/Productivity-Kategorien, Review Notes, Review-Kontakt, Demo-Zugang, neutrale iPhone-/iPad-Screenshots, ehrliche Altersdeklaration und veroeffentlichte Privacy Labels in ASC gesetzt | iOS `fastlane/metadata`, `fastlane/screenshots`, `docs/app-review-notes.md`, `store_review_details`, `store_privacy_labels` | Fastlane-Laeufe, ASC-Readback mit 15 Privacy-Deklarationen und echter Demo-Login | Erfuellt | Product Page vor Einreichung visuell endkontrollieren |
