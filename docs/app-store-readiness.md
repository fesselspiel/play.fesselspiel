...
| 1.6 | Datensicherheit | Bearer only, Keychain, TLS, Privacy Overlay, Dateischutz, Quarantaene | Auth-, Datei- und iOS-Sicherheitscode | Token-, Datei- und Simulator-Smokes | Erfuellt | Externen Malware-Scanner separat bewerten |
