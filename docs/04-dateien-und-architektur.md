...
- `src/app/api/external/catalog/position-categories/route.ts`
- `src/app/api/external/catalog/position-categories/[id]/route.ts`
...
- `src/app/api/external/automation/adapter/commands/[id]/result/route.ts`
