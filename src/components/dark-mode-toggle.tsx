...
export function DarkModeToggle({ active }: { active: boolean }) {
  ...
  return (
    <button
      ...
      onClick={toggle}
      disabled={isPending}
      className="flex min-h-10 w-full items-center justify-between gap-3 rounded-md px-3 py-2 text-sm font-medium text-graphite hover:bg-paper hover:text-redbrand disabled:opacity-70"
    >
