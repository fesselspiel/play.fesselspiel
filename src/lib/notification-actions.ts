...
export const knownAuditActions = [
  ...
  ["packing_event_deleted_api", "Pack-Event per API gelöscht"],
  ["packing_list_created", "Packliste angelegt"],
  ["packing_list_created_api", "Packliste per API angelegt"],
  ["packing_list_updated_api", "Packliste per API geändert"],
  ["packing_list_deleted", "Packliste gelöscht"],
  ["packing_list_deleted_api", "Packliste per API gelöscht"],
  ["packing_item_added", "Spielzeug zur Packliste hinzugefügt"],
  ["packing_item_added_api", "Spielzeug per API zur Packliste hinzugefügt"],
  ["packing_item_packed", "Spielzeug eingepackt"],
  ["packing_item_packed_api", "Spielzeug per API eingepackt"],
  ["packing_item_unpacked", "Spielzeug ausgepackt"],
  ["packing_item_unpacked_api", "Spielzeug per API ausgepackt"],
  ...
  ["self_bondage_order_accepted", "Auftrag angenommen"],
  ["self_bondage_order_completed", "Auftrag umgesetzt"],
  ["self_bondage_order_created", "Auftrag erteilt"],
  ["self_bondage_order_discarded", "Auftrag verworfen"],
  ["self_bondage_order_updated", "Auftrag geändert"],
  ...
  ["tracker_entry_liked", "Tracker-Eintrag geliked"],
  ["tracker_entry_unliked", "Tracker-Eintrag-Like entfernt"],
