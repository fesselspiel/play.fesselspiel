export const knownAuditActions = [
  ["activity_confirmed", "Spielplan bestaetigt"],
  ["activity_created", "Spielplan angelegt"],
  ["activity_confirmed_telegram", "Spielplan per Telegram bestaetigt"],
