    ...
    actions: [
      {
        ...
        apiEndpoints: [
          ...
          { method: "PATCH", path: "/api/external/chat/circles/{id}", description: "Admins benennen einen Zirkel der aktiven Seite mit `{ name }` um." },
          { method: "DELETE", path: "/api/external/chat/circles/{id}", description: "Admins löschen einen Zirkel nur, wenn keine Mitglieder, Nachrichten, Freigaben oder Regeln mehr darauf verweisen." }
        ]
      },
      {
        key: "list",
    ...
    actions: [
      {
        ...
        apiEndpoints: [
          { method: "GET", path: "/api/external/content-spaces", description: "Sichtbare Bereiche lesen; bestehendes Tagebuch und bestehende Ideen werden verlustfrei in echte Standardbereiche migriert." },
          ...
          { method: "GET", path: "/api/external/content-spaces/{id}/entries", description: "Eintraege inklusive migrierter Wiki- und Ideenobjekte lesen." },
          ...
          { method: "DELETE", path: "/api/external/content-spaces/{id}/entries/{entryId}", description: "Eigenen Eintrag loeschen." },
